package com.example.cruisemaster.againguestdetails.fragment
...
class GuestDetailsFragment : Fragment() {
    ...
    private fun initViewModels() {
        guestDetailsViewModel = ViewModelProvider(
            this,
            GuestDeatilViewModelFactory(
                GuestDetailsRepositary(
                    GuestDetailsApiService.getInstance()
                )
            )

        )[GuestDetailsViewModel::class.java]
